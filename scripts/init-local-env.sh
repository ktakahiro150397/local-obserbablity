...
CODEX_ROLLUP_UID_GID=${lgtm_uid_gid}
CODEX_ROLLUP_UID=$(id -u)
CODEX_ROLLUP_GID=$(id -g)
...
CODEX_ROLLUP_MEMORY_LIMIT=192m
...
CODEX_ROLLUP_CPU_LIMIT=0.25
HERMES_ROLLUP_INTERVAL_SECONDS=300
HERMES_ROLLUP_OVERLAP_SECONDS=1800
HERMES_ROLLUP_GRACE_SECONDS=120
CODEX_ROLLUP_INTERVAL_SECONDS=300
CODEX_ROLLUP_OVERLAP_SECONDS=1800
CODEX_ROLLUP_GRACE_SECONDS=120
EOF
  chmod 600 -- "${env_file}"
  ...
  for ledger_setting in \
    ...
    CODEX_ROLLUP_INTERVAL_SECONDS=300 \
    CODEX_ROLLUP_OVERLAP_SECONDS=1800 \
    CODEX_ROLLUP_GRACE_SECONDS=120; do
