...
Read [`../docs/public-access.md`](../docs/public-access.md) before implementing.
...
The Access application authorizes exact approved email addresses. It must not use `Everyone`, bypass policies, shared accounts, or Google group membership as the Phase 1 authorization boundary.
...
Do not replace these placeholders in tracked files. Record the actual team name only in ignored local documentation or service configuration.
